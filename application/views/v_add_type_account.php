...
<html>
    ...
    <body>
        <div style="width:400px;margin:200px auto;background-color: #32BDDC;color: red;border-radius: 10px 10px 10px 10px;text-align: center;"> 
            ...
            <input style="font-style: italic;width:75%;margin-bottom: 10px;height: 35px;border-radius: 7px 7px 7px 7px;font-size: 20px;" type="text" size="20" id="username" name="username" placeholder="name"/>
            <br/>
