...
<html>
    ...
    <body>
        <div style="width:400px;margin:200px auto;background-color: #32BDDC;color: red;border-radius: 10px 10px 10px 10px;text-align: center;"> 
            ...
            <?php echo form_open('add/verify_add_account'); ?>
            <input style="font-style: italic;width:75%;margin-bottom: 10px;height: 35px;border-radius: 7px 7px 7px 7px;font-size: 20px;" type="text" size="20" id="username" name="username" placeholder="username"/>
            <br/>
            <input style="font-style: italic;width:75%;margin-bottom: 10px;height: 35px;border-radius: 7px 7px 7px 7px;font-size: 20px;" type="password" size="20" id="password" name="password" placeholder="password"/>
            <br/>
            ...
            <br/>
            <input style="font-style: italic;width:75%;margin-bottom: 10px;height: 35px;border-radius: 7px 7px 7px 7px;font-size: 20px;" type="text" size="20" id="secret-question" name="secret-question" placeholder="secret-question"/>
            <br/>
            <input style="font-style: italic;width:75%;margin-bottom: 10px;height: 35px;border-radius: 7px 7px 7px 7px;font-size: 20px;" type="text" size="20" id="answer" name="answer" placeholder="answer"/>
            <br/>
